<?php $title = 'InternShipp - Apply'; ?>
<?php $style = 'manage_account/manage_account.css'; ?>

<?php ob_start(); ?>
<!-- Content -->
<div class="modal">
    <h5> Apply to the offer</h5>
    <p class="subtitle1"> Here you can apply to a company.</p>
    <form action="" method="POST">
        ...
        <button type="submit">
            <p class="button"><?= isset($companyInfo) ? "Modify Account" : "Create Account" ?></p>
        </button>
